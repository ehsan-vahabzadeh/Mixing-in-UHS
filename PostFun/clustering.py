...
for cluster_id in range(n_clusters):
    ...
    # LHS sampling for (flow, cycle); CG set to 0 here (as in your code)
...
# === 7. (Optional) Permeability binning plot AFTER sampling (keeps Cluster intact above) ===
bins = [-np.inf, 10, 100, np.inf]
labels = ["<10 mD", "10–100 mD", ">100 mD"]

# Reassign Cluster to bins for this *separate* view
